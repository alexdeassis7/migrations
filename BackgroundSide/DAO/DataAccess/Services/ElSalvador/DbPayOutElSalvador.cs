...
namespace DAO.DataAccess.Services.ElSalvador
{
    public class DbPayOutElSalvador
    {
        SqlConnection _conn;
        SqlCommand _cmd;
        SqlParameter _prm;
        ...
        public LotBatchModel CreateLotTransaction(LotBatchModel data, string customer, string countryCode, bool TransactionMechanism)
        {
            ...
            try
            {
                ...
                _cmd = new SqlCommand("[LP_Operation].[SLV_Payout_Generic_Entity_Operation_Create]", _conn)
                {
        ...
        public ElSalvadorPayoutDownloadResponse DownloadBatchLotTransactionToBank(bool TransactionMechanism, string JSON, string providerName)
        {

            var result = new ElSalvadorPayoutDownloadResponse();
        ...
        public List<ElSalvadorTransactionDetail> UpdateLotBatchTransactionFromBank(Int64 CurrencyFxClose, bool TransactionMechanism, List<Payouts.UploadModel> uploadModel)
        {
            var Detail = new List<ElSalvadorTransactionDetail>();
            ...
            try
            {
                ...
                {
                    Detail.Add(DataRowHelper.CreateItemFromRow<ElSalvadorTransactionDetail>(row));
                }
