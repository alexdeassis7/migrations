...
namespace DAO.DataAccess.Services.Ecuador
{
    public class DbPayOutEcuador
    {
        SqlConnection _conn;
        SqlCommand _cmd;
        SqlParameter _prm;
        ...
        public LotBatchModel CreateLotTransaction(LotBatchModel data, string customer, string countryCode, bool TransactionMechanism)
        {
            ...
            try
            {
                ...
                _cmd = new SqlCommand("[LP_Operation].[ECU_Payout_Generic_Entity_Operation_Create]", _conn)
                {
        ...
        public EcuadorPayoutDownloadResponse DownloadBatchLotTransactionToBank(bool TransactionMechanism, string JSON, string providerName)
        {

            var result = new EcuadorPayoutDownloadResponse();
            ...
            try
            {
                ...
                {
                    case "Produbanco":
                        sp = "[LP_Operation].[ECU_Payout_PRODUBANCO_Bank_Operation_Download]";
                        break;
                }
        ...
        public List<EcuadorTransactionDetail> UpdateLotBatchTransactionFromBank(Int64 CurrencyFxClose, bool TransactionMechanism, List<Payouts.UploadModel> uploadModel)
        {
            var Detail = new List<EcuadorTransactionDetail>();
            ...
            try
            {
                ...
                {
                    Detail.Add(DataRowHelper.CreateItemFromRow<EcuadorTransactionDetail>(row));
                }
