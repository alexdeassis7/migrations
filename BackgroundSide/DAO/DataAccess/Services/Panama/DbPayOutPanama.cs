...
namespace DAO.DataAccess.Services.Panama
{
    public class DbPayOutPanama
    {
        SqlConnection _conn;
        SqlCommand _cmd;
        SqlParameter _prm;
        ...
        public LotBatchModel CreateLotTransaction(LotBatchModel data, string customer, string countryCode, bool TransactionMechanism)
        {
            ...
            try
            {
                ...
                _cmd = new SqlCommand("[LP_Operation].[PAN_Payout_Generic_Entity_Operation_Create]", _conn)
                {
        ...
        public PanamaPayoutDownloadResponse DownloadBatchLotTransactionToBank(bool TransactionMechanism, string JSON, string providerName)
        {

            var result = new PanamaPayoutDownloadResponse();
        ...
        public List<PanamaTransactionDetail> UpdateLotBatchTransactionFromBank(Int64 CurrencyFxClose, bool TransactionMechanism, List<Payouts.UploadModel> uploadModel)
        {
            var Detail = new List<PanamaTransactionDetail>();
            ...
            try
            {
                ...
                _cmd = new SqlCommand("[LP_Operation].[PAN_Payout_ITAU_Bank_Operation_Upload]", _conn)
                {
                    CommandType = CommandType.StoredProcedure,
                    CommandTimeout = 0
                };
                ...
                {
                    Detail.Add(DataRowHelper.CreateItemFromRow<PanamaTransactionDetail>(row));
                }
