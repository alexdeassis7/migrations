...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
    public class BoliviaPayoutCreateRequest
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [RegularExpression("^USD$|^BOB$", ErrorMessage = "Parameter :: currency :: invalid format, only allow codes: 'USD' | 'BOB'.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [Range(100, 5000000000, ErrorMessage = "Parameter :: amount :: value out of range [100 - 5000000000].#INVALID")]
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [CustomRequired(regularExpression: "(CI|CE|NIT|PASS)$", errorMessageForRegularExpression: "Parameter :: beneficiary_document_type :: invalid format, only allow codes: 'CI', 'CE', 'NIT', 'PASS' .#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        public string beneficiary_document_type { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente

        [CustomRequired(minLength: 5, maxLength: 15)]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [CustomRequired(minLength: 7, maxLength: 14, regularExpression: "^[0-9]*$", errorMessageForRegularExpression: "Parameter :: beneficiary_account_number :: invalid format  .#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
