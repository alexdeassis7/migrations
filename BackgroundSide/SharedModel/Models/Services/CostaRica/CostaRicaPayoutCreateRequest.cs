...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
    public class CostaRicaPayoutCreateRequest
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [RegularExpression("^CRC$", ErrorMessage = "Parameter :: currency :: invalid format, only allowed code: 'USD'.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [Range(100, 450000000000, ErrorMessage = "Parameter :: amount :: value out of range [100 - 450000000000].#INVALID")]
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [RegularExpression("(CI|CJ|CR)$", ErrorMessage = "Parameter :: beneficiary_document_type :: invalid format, only allow codes: 'CI', 'CJ', 'CR' .#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [StringLength(22, MinimumLength = 9, ErrorMessage = "Parameter :: beneficiary_document_id :: invalid length .#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [StringLength(22, MinimumLength = 22, ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format. length must be 6 to 50")]
        [RegularExpression("^[0-9]{22}$", ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format, only allow: numbers and length has 50 characters.")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
