...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [RegularExpression("^[ACDP]{1}$", ErrorMessage = "Parameter :: bank_account_type :: invalid format, only characters available: 'C' – checking account, 'A' – savings account 'D' - debit card, 'P' - cell phone account,.#INVALID")]
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [StringLength(18, MinimumLength = 10,  ErrorMessage = "Parameter :: beneficiary_account_number :: invalid length.#LENGTH")]
                //[RegularExpression("^[0-9]{18}$", ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format, only allow: numbers and length has 18 characters.")]
