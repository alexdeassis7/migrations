...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
    public class ParaguayPayoutCreateRequest
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [RegularExpression("^USD$|^PYG$", ErrorMessage = "Parameter :: currency :: invalid format, only allow codes: 'USD' | 'PYG'.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [Range(100, 400000000000, ErrorMessage = "Parameter :: amount :: value out of range [100 - 400000000000].#INVALID")]
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [RegularExpression("(CI|RUC)$", ErrorMessage = "Parameter :: beneficiary_document_type :: invalid format, only allow codes: 'CI', 'RUC' .#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        ...
        [RegularExpression("(C|A)$", ErrorMessage = "Parameter :: bank_account_type :: invalid format, only characters available: 'C' – checking account, 'A' – savings account.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        public string bank_account_type { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente

        [JsonProperty(Order = 15)]
        [StringLength(16, MinimumLength = 1, ErrorMessage = "Parameter :: beneficiary_account_number :: has minimun 1 characters and 16 characters maximum.#LENGTH")]
        [RegularExpression("^[0-9]{1,16}$", ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format, only allow: has minimun 1 characters and 16 characters maximum.#LENGTH")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
