...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [StringLength(12, MinimumLength = 4, ErrorMessage = "Parameter :: beneficiary_document_id :: invalid length .#INVALID")]
                [RegularExpression("^[0-9]{4,12}$", ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format, only allow: numbers and length has 12 characters.")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [RegularExpression("^[AC]{1}$", ErrorMessage = "Parameter :: bank_account_type :: invalid format, only characters available: 'C' – checking account, 'A' – savings account Account.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [StringLength(20, ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format. length must be 6 to 50")]
                [RegularExpression("^[0-9]{20}$", ErrorMessage = "Parameter :: beneficiary_account_number :: invalid format, only allow: numbers and length has 50 characters.")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
