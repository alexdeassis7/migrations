...
namespace SharedModel.Models.Services.Banks.Galicia
{
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [RegularExpression("^USD$|^ARS$", ErrorMessage = "Parameter :: currency :: invalid format, only allow codes: 'USD' | 'ARS'.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [Required(ErrorMessage = "Parameter :: beneficiary_cuit :: is required.#REQUIRED")]
                [StringLength(11, MinimumLength = 11, ErrorMessage = "Parameter :: beneficiary_cuit :: incorrect length, the correct format has 11 characters.#LENGTH")]
                [RegularExpression("^(\\b(20|23|24|27|30|33|34)(\\D)?[0-9]{8}(\\D)?[0-9])$", ErrorMessage = "Parameter :: beneficiary_cuit :: invalid format, only allow: numbers.#INVALID")]
                [CUIT(ErrorMessage = "Parameter :: beneficiary_cuit :: invalid CUIT.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [Required(ErrorMessage = "Parameter :: bank_cbu :: is required.#REQUIRED")]
                [RegularExpression("^[0-9]{22}$", ErrorMessage = "Parameter :: bank_cbu :: invalid format, only allow: numbers and length has 22 characters.#INVALID")]
                [CBU(ErrorMessage = "Parameter :: bank_cbu :: invalid CBU.#INVALID")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
...
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                public Int64 withholding_tax_afip { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                [JsonProperty(Order = 29)]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                public Int64 withholding_tax_arba { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                [JsonProperty(Order = 30)]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                public Int64 withholding_tax_agip { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
            }
        }
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                ...
                [Range(100, 1000000000, ErrorMessage = "Parameter :: amount :: value out range [100 - 1000000000].")]
                [RegularExpression("^[0-9]{3,10}$", ErrorMessage = "Parameter :: amount :: invalid length, must be between 3 and 10 characters.")]
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                public Int64 amount { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
                [JsonProperty(Order = 21)]
...
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
            public string payin_in_progress_amt { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
#pragma warning disable CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
            public string payin_in_progress_cnt { get; set; }
#pragma warning restore CS1591 // Falta el comentario XML para el tipo o miembro visible públicamente
        }
    }
}
