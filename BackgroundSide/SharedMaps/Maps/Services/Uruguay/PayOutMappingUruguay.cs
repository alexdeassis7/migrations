...
namespace SharedMaps.Maps.Services.Uruguay
{
    public class PayOutMappingUruguay : Profile
    {
        public PayOutMappingUruguay()
        {
            #region POST API-DTO|DTO-API

            #region POST API-DTO
            CreateMap<PayOutUruguay.Create.Request, SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            CreateMap<PayOutUruguay.Create.Request, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            ...
            CreateMap<PayOutUruguay.Create.Request, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            CreateMap<PayOutUruguay.List.Response, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
                .ForMember(to => to.SenderName, from => from.MapFrom(x => x.sender_name))
                .ForMember(to => to.SenderCountry, from => from.MapFrom(x => x.sender_country))
                .ForMember(to => to.SenderState, from => from.MapFrom(x => x.sender_state))
                .ForMember(to => to.SenderAddress, from => from.MapFrom(x => x.sender_address))
            ...
            CreateMap<PayOutUruguay.Create.Request, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
                .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.submerchant_code));

            CreateMap<List<PayOutUruguay.Create.Request>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
            {
                ...
                foreach (PayOutUruguay.Create.Request item in lRequest)
                {
            ...
            #region POST DTO-API
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, PayOutUruguay.Create.Response>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation, PayOutUruguay.Create.Response>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, PayOutUruguay.Create.Response>()
                .ForMember(to => to.submerchant_code, from => from.MapFrom(x => x.SubMerchantIdentification));

            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, List<PayOutUruguay.Create.Response>>().ConvertUsing((LotBatch, lRequest) =>
            {
                lRequest = new List<PayOutUruguay.Create.Response>();

                PayOutUruguay.Create.Response ResponseTransaction = new PayOutUruguay.Create.Response();

                foreach (SharedModelDTO.Models.Transaction.TransactionModel item in LotBatch.Transactions)
                {
                    ResponseTransaction = Mapper.Map<PayOutUruguay.Create.Response>(item.TransactionCustomerInformation);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, PayOutUruguay.Create.Response>(item.TransactionRecipientDetail, ResponseTransaction);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, PayOutUruguay.Create.Response>(item.TransactionSubMerchantDetail, ResponseTransaction);
            ...
            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, SharedModel.Models.Services.Uruguay.PayOutUruguay.LotBatch>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.TransactionModel, SharedModel.Models.Services.Uruguay.PayOutUruguay.List.Response>()
