...
namespace SharedMaps.Maps.Services.ElSalvador
{
    public class PayOutMappingElSalvador : Profile
    {
        public PayOutMappingElSalvador()
        {
            #region POST API-DTO|DTO-API

            #region POST API-DTO
            CreateMap<ElSalvadorPayoutCreateRequest, SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            CreateMap<ElSalvadorPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            ...
            CreateMap<ElSalvadorPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            CreateMap<ElSalvadorPayoutCreateResponse, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
                //.ForMember(to => to.Email, from => from.MapFrom(x => x.beneficiary_email))
                //.ForMember(to => to.BirthDate, from => from.MapFrom(x => x.beneficiary_birth_date))
                //.ForMember(to => to.Address, from => from.MapFrom(x => x.beneficiary_address))
                //.ForMember(to => to.Country, from => from.MapFrom(x => x.beneficiary_country))
            ...
            CreateMap<ElSalvadorPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
                .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.submerchant_code));

            CreateMap<List<ElSalvadorPayoutCreateRequest>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
            {
                ...
                foreach (ElSalvadorPayoutCreateRequest item in lRequest)
                {
            ...
            #region POST DTO-API
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, ElSalvadorPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation, ElSalvadorPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, ElSalvadorPayoutCreateResponse>()
                .ForMember(to => to.submerchant_code, from => from.MapFrom(x => x.SubMerchantIdentification));

            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, List<ElSalvadorPayoutCreateResponse>>().ConvertUsing((LotBatch, lRequest) =>
            {
                lRequest = new List<ElSalvadorPayoutCreateResponse>();

                ElSalvadorPayoutCreateResponse ResponseTransaction = new ElSalvadorPayoutCreateResponse();

                foreach (SharedModelDTO.Models.Transaction.TransactionModel item in LotBatch.Transactions)
                {
                    ResponseTransaction = Mapper.Map<ElSalvadorPayoutCreateResponse>(item.TransactionCustomerInformation);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, ElSalvadorPayoutCreateResponse>(item.TransactionRecipientDetail, ResponseTransaction);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, ElSalvadorPayoutCreateResponse>(item.TransactionSubMerchantDetail, ResponseTransaction);
            ...
            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, ElSalvadorPayoutLotBatch>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.TransactionModel, ElSalvadorPayoutListResponse>()
