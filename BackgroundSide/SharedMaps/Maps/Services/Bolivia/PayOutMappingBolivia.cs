...
namespace SharedMaps.Maps.Services.Bolivia
{
    public class PayOutMappingBolivia : Profile
    {
        public PayOutMappingBolivia()
        {
            #region POST API-DTO|DTO-API

            #region POST API-DTO
            CreateMap<BoliviaPayoutCreateRequest, SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            CreateMap<BoliviaPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            ...
            CreateMap<BoliviaPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            CreateMap<BoliviaPayoutCreateResponse, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
                //.ForMember(to => to.Email, from => from.MapFrom(x => x.beneficiary_email))
                //.ForMember(to => to.BirthDate, from => from.MapFrom(x => x.beneficiary_birth_date))
                //.ForMember(to => to.Address, from => from.MapFrom(x => x.beneficiary_address))
                //.ForMember(to => to.Country, from => from.MapFrom(x => x.beneficiary_country))
            ...
            CreateMap<BoliviaPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
                .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.submerchant_code));

            CreateMap<List<BoliviaPayoutCreateRequest>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
            {
                ...
                foreach (BoliviaPayoutCreateRequest item in lRequest)
                {
            ...
            #region POST DTO-API
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, BoliviaPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation, BoliviaPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, BoliviaPayoutCreateResponse>()
                .ForMember(to => to.submerchant_code, from => from.MapFrom(x => x.SubMerchantIdentification));

            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, List<BoliviaPayoutCreateResponse>>().ConvertUsing((LotBatch, lRequest) =>
            {
                lRequest = new List<BoliviaPayoutCreateResponse>();

                BoliviaPayoutCreateResponse ResponseTransaction = new BoliviaPayoutCreateResponse();

                foreach (SharedModelDTO.Models.Transaction.TransactionModel item in LotBatch.Transactions)
                {
                    ResponseTransaction = Mapper.Map<BoliviaPayoutCreateResponse>(item.TransactionCustomerInformation);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, BoliviaPayoutCreateResponse>(item.TransactionRecipientDetail, ResponseTransaction);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, BoliviaPayoutCreateResponse>(item.TransactionSubMerchantDetail, ResponseTransaction);
            ...
            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, BoliviaPayoutLotBatch>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.TransactionModel, BoliviaPayoutListResponse>()
