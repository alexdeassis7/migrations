...
namespace SharedMaps.Maps.Services.CostaRica
{
    public class PayOutMappingCostaRica : Profile
    {
        public PayOutMappingCostaRica()
        {
            #region POST API-DTO|DTO-API

            #region POST API-DTO
            CreateMap<CostaRicaPayoutCreateRequest, SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            CreateMap<CostaRicaPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            ...
            CreateMap<CostaRicaPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            CreateMap<CostaRicaPayoutCreateResponse, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
                //.ForMember(to => to.Email, from => from.MapFrom(x => x.beneficiary_email))
                //.ForMember(to => to.BirthDate, from => from.MapFrom(x => x.beneficiary_birth_date))
                //.ForMember(to => to.Address, from => from.MapFrom(x => x.beneficiary_address))
                //.ForMember(to => to.Country, from => from.MapFrom(x => x.beneficiary_country))
            ...
            CreateMap<CostaRicaPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
                .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.submerchant_code));

            CreateMap<List<CostaRicaPayoutCreateRequest>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
            {
                ...
                foreach (CostaRicaPayoutCreateRequest item in lRequest)
                {
            ...
            #region POST DTO-API
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, CostaRicaPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation, CostaRicaPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, CostaRicaPayoutCreateResponse>()
                .ForMember(to => to.submerchant_code, from => from.MapFrom(x => x.SubMerchantIdentification));

            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, List<CostaRicaPayoutCreateResponse>>().ConvertUsing((LotBatch, lRequest) =>
            {
                lRequest = new List<CostaRicaPayoutCreateResponse>();

                CostaRicaPayoutCreateResponse ResponseTransaction = new CostaRicaPayoutCreateResponse();

                foreach (SharedModelDTO.Models.Transaction.TransactionModel item in LotBatch.Transactions)
                {
                    ResponseTransaction = Mapper.Map<CostaRicaPayoutCreateResponse>(item.TransactionCustomerInformation);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, CostaRicaPayoutCreateResponse>(item.TransactionRecipientDetail, ResponseTransaction);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, CostaRicaPayoutCreateResponse>(item.TransactionSubMerchantDetail, ResponseTransaction);
            ...
            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, CostaRicaPayoutLotBatch>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.TransactionModel, CostaRicaPayoutListResponse>()
