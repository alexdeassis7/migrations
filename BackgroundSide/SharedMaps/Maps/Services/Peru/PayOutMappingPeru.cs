...
namespace SharedMaps.Maps.Services.Peru
{
    public class PayOutMappingPeru : Profile
    {
        public PayOutMappingPeru()
        {
            #region POST API-DTO|DTO-API

            #region POST API-DTO
            CreateMap<PeruPayoutCreateRequest, SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            CreateMap<PeruPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            ...
            CreateMap<PeruPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            CreateMap<PeruPayoutListResponse, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
                //.ForMember(to => to.Email, from => from.MapFrom(x => x.beneficiary_email))
                //.ForMember(to => to.BirthDate, from => from.MapFrom(x => x.beneficiary_birth_date))
                //.ForMember(to => to.Address, from => from.MapFrom(x => x.beneficiary_address))
                //.ForMember(to => to.Country, from => from.MapFrom(x => x.beneficiary_country))
            ...
            CreateMap<PeruPayoutCreateRequest, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
                .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.submerchant_code));

            CreateMap<List<PeruPayoutCreateRequest>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
            {
                ...
                foreach (PeruPayoutCreateRequest item in lRequest)
                {
            ...
            #region POST DTO-API
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, PeruPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation, PeruPayoutCreateResponse>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, PeruPayoutCreateResponse>()
                .ForMember(to => to.submerchant_code, from => from.MapFrom(x => x.SubMerchantIdentification));

            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, List<PeruPayoutCreateResponse>>().ConvertUsing((LotBatch, lRequest) =>
            {
                lRequest = new List<PeruPayoutCreateResponse>();

                PeruPayoutCreateResponse ResponseTransaction = new PeruPayoutCreateResponse();

                foreach (SharedModelDTO.Models.Transaction.TransactionModel item in LotBatch.Transactions)
                {
                    ResponseTransaction = Mapper.Map<PeruPayoutCreateResponse>(item.TransactionCustomerInformation);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, PeruPayoutCreateResponse>(item.TransactionRecipientDetail, ResponseTransaction);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, PeruPayoutCreateResponse>(item.TransactionSubMerchantDetail, ResponseTransaction);
            ...
            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, PeruPayoutLotBatch>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.TransactionModel, PeruPayoutListResponse>()
