...
namespace SharedMaps.Maps.Services.Brasil
{
    public class PayOutMappingBrasil : Profile
    {
        public PayOutMappingBrasil()
        {
            #region POST API-DTO|DTO-API

            #region POST API-DTO
            CreateMap<PayOutBrasil.Create.Request, SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            CreateMap<PayOutBrasil.Create.Request, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            ...
            CreateMap<PayOutBrasil.Create.Request, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            CreateMap<PayOutBrasil.List.Response, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
                .ForMember(to => to.SenderName, from => from.MapFrom(x => x.sender_name))
                .ForMember(to => to.SenderCountry, from => from.MapFrom(x => x.sender_country))
                .ForMember(to => to.SenderState, from => from.MapFrom(x => x.sender_state))
                .ForMember(to => to.SenderAddress, from => from.MapFrom(x => x.sender_address))
                ...
                CreateMap<PayOutBrasil.Create.Request, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
                    .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.submerchant_code));

                CreateMap<List<PayOutBrasil.Create.Request>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
                {
                ...
                foreach (PayOutBrasil.Create.Request item in lRequest)
                {
            ...
            #region POST DTO-API
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, PayOutBrasil.Create.Response>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation, PayOutBrasil.Create.Response>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, PayOutBrasil.Create.Response>()
                .ForMember(to => to.submerchant_code, from => from.MapFrom(x => x.SubMerchantIdentification));

            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, List<PayOutBrasil.Create.Response>>().ConvertUsing((LotBatch, lRequest) =>
            {
                lRequest = new List<PayOutBrasil.Create.Response>();

                PayOutBrasil.Create.Response ResponseTransaction = new PayOutBrasil.Create.Response();

                foreach (SharedModelDTO.Models.Transaction.TransactionModel item in LotBatch.Transactions)
                {
                    ResponseTransaction = Mapper.Map<PayOutBrasil.Create.Response>(item.TransactionCustomerInformation);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel, PayOutBrasil.Create.Response>(item.TransactionRecipientDetail, ResponseTransaction);
                    ResponseTransaction = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel, PayOutBrasil.Create.Response>(item.TransactionSubMerchantDetail, ResponseTransaction);
            ...
            #region PUT API-DTO
            //CreateMap<PayOutBrasil.Update.Request, SharedModelDTO.Models.Transaction.TransactionModel>()
            //.ForMember(to => to.Value, from => from.MapFrom(x => x.amount))
            //.ForMember(to => to.TransactionDate, from => from.MapFrom(x => DateTime.Now.ToString("yyyyMMdd")))
            ...
            //CreateMap<PayOutBrasil.Update.Request, SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>()
            // //.ForMember(to => to.CBU, from => from.MapFrom(x => x.bank_cbu))
            // .ForMember(to => to.IdType, from => from.MapFrom(x => x.type_of_id))
            ...
            //CreateMap<PayOutBrasil.Update.Request, SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>()
            ...
            //CreateMap<PayOutBrasil.Update.Request, SharedModelDTO.Models.Transaction.Detail.TransactionSubMerchantDetailModel>()
            //    .ForMember(to => to.SubMerchantIdentification, from => from.MapFrom(x => x.subclient_code));

            //CreateMap<List<PayOutBrasil.Update.Request>, SharedModelDTO.Models.LotBatch.LotBatchModel>().ConvertUsing((lRequest, LotBatch) =>
            //{
            //    LotBatch = new SharedModelDTO.Models.LotBatch.LotBatchModel()
            //    {
            //        Transactions = new List<SharedModelDTO.Models.Transaction.TransactionModel>()
            ...
            //    foreach (PayOutBrasil.Update.Request item in lRequest)
            //    {
            //        TransactionToAdd = Mapper.Map<SharedModelDTO.Models.Transaction.TransactionModel>(item);
            //        TransactionToAdd.TransactionRecipientDetail = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionRecipientDetailModel>(item);
            //        TransactionToAdd.TransactionCustomerInformation = Mapper.Map<SharedModelDTO.Models.Transaction.Detail.TransactionCustomerInformation>(item);
            ...
            CreateMap<SharedModelDTO.Models.LotBatch.LotBatchModel, SharedModel.Models.Services.Brasil.PayOutBrasil.LotBatch>()
            ...
            CreateMap<SharedModelDTO.Models.Transaction.TransactionModel, SharedModel.Models.Services.Brasil.PayOutBrasil.List.Response>()
            ...
            .ForMember(to => to.beneficiary_document_id, from => from.MapFrom(x => x.TransactionRecipientDetail.RecipientCUIT))
