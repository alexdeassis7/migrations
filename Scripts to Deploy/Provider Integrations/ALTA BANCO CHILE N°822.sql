...
DECLARE @PAIS				VARCHAR(MAX)	= 'CHILE';			-- Ej. EJEMPLO ARGENTINA
DECLARE @CODE				VARCHAR(10)		= 'BCHILE822';			-- Ej. ABC
DECLARE @NAME				VARCHAR(60)		= 'BANCO CHILE N°822'; -- Ej. Banco ABC
DECLARE @LONG_DESCRIPTION	VARCHAR(60)		= 'Banco de Chile Nomina (822) - Bancos Locales y Banco de Chile'; -- Ej  Banco ABC de Formosa
