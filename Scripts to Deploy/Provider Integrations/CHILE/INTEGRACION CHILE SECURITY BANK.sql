...
DECLARE @CODE				VARCHAR(10)		= 'SEC';			-- Ej. ABC
DECLARE @NAME				VARCHAR(60)		= 'BANCO Security'; -- Ej. Banco ABC
DECLARE @LONG_DESCRIPTION	VARCHAR(60)		= 'BANCO Security'; -- Ej  Banco ABC de Formosa
