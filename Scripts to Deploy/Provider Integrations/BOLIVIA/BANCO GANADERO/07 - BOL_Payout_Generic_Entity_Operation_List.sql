...
GO
/****** Object:  StoredProcedure [LP_Operation].[BOL_Payout_Generic_Entity_Operation_List]    Script Date: 8/8/2022 14:16:51 ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [LP_Operation].[BOL_Payout_Generic_Entity_Operation_List]
                                      (
                                        @customer       VARCHAR(12)
...
*/
  ...
  SET @idCountry = [LP_Location].fnGetIdCountyByCountryCode('BOB')
