...
GO
/****** Object:  StoredProcedure [LP_KPI].[BOL_Payout_Generic_fx_Create]    Script Date: 12/7/2022 16:22:05 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [LP_KPI].[BOL_Payout_Generic_fx_Create]
																	(
				...
				BEGIN TRANSACTION
					...
					BEGIN
						...
						BEGIN
							...
							SET @Spread_fxValue_Buy = ( SELECT [Base_Sell] FROM [LP_Configuration].[CurrencyBase] WHERE [idCurrencyBase] = @idCurrencyBase )
