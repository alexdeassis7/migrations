...
VALUES (
'RENDBRTED',--esto ponemos codigo a nuestro gusto tratando que sea unico como "ITAUBR"
'Rendimento Brazil TED',
'Rendimento Brazil TED',
@countryId,
1
)
...
SET @idPayWayService = (select idPayWayService
					from [LP_Configuration].[PayWayServices]
					where code = 'BANKDEPO' and idCountry = @countryId)
