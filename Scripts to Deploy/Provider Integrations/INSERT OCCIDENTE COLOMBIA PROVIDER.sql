...
ALTER TABLE LP_Operation.Ticket ADD TicketAlternative12 VARCHAR(12)
...
(@idProvider, @idCountryColombia, 1, 'R02', 'ERROR BANK ACCOUNT CLOSED', 'ERROR BANK ACCOUNT CLOSED', @idInternalStatusType, 1, 1),
(@idProvider, @idCountryColombia, 1, 'R18', 'ERROR AMOUNT INCORRECT', 'ERROR AMOUNT INCORRECT', @idInternalStatusType, 1, 1),
(@idProvider, @idCountryColombia, 1, 'R10', 'ERROR BENEFICIARY DOCUMENT ID INVALID', 'ERROR BENEFICIARY DOCUMENT ID INVALID', @idInternalStatusType, 1, 1),
(@idProvider, @idCountryColombia, 1, 'R11', 'ERROR BENEFICIARY NAME INCORRECT', 'ERROR BENEFICIARY NAME INCORRECT', @idInternalStatusType, 1, 1),
(@idProvider, @idCountryColombia, 1, 'R13', 'ERROR BANK PROCESSING', 'ERROR BANK PROCESSING', @idInternalStatusType, 1, 1),
(@idProvider, @idCountryColombia, 1, 'R03', 'ERROR ACCOUNT NOT MATCH BENEFICIARY DOCUMENT', 'ERROR ACCOUNT NOT MATCH BENEFICIARY DOCUMENT', @idInternalStatusType, 1, 1)
