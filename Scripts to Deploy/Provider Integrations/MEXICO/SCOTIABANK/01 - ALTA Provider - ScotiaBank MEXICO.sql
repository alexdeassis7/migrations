...
DECLARE @PAIS				VARCHAR(MAX)	= 'MEXICO';			-- Ej. EJEMPLO ARGENTINA
DECLARE @CODE				VARCHAR(7)		= 'SCOTMEX';			-- Ej. ABC
DECLARE @NAME				VARCHAR(60)		= 'SCOTIABANK MEXICO'; -- Ej. Banco ABC
DECLARE @LONG_DESCRIPTION	VARCHAR(60)		= 'Banco Scotiabank (MEX)'; -- Ej  Banco ABC de Formosa
