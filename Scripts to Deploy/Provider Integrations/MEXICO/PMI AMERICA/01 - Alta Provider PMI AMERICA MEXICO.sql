...
DECLARE @CODE				VARCHAR(10)		= 'PMIMEX';			-- Ej. ABC
DECLARE @NAME				VARCHAR(60)		= 'PMI Americas'; -- Ej. Banco ABC
DECLARE @LONG_DESCRIPTION	VARCHAR(60)		= 'Banco PMI Americas'; -- Ej  Banco ABC de Formosa
