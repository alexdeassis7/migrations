...
DECLARE @CODE				VARCHAR(10)		= 'BCHILE816';			-- Ej. ABC
DECLARE @NAME				VARCHAR(60)		= 'BANCO CHILE N°816'; -- Ej. Banco ABC
DECLARE @LONG_DESCRIPTION	VARCHAR(60)		= 'Banco de Chile Nomina (816)'; 
