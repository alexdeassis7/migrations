...
values ('Paydek Argentina', 'Paydek Argentina', 'alan.barry@paydek.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'PAYDEKARG',1,2493,'0.900000')
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod, CommissionCurrency,CommissionValue)
values ('Paydek Colombia', 'Paydek Colombia', 'alan.barry@paydek.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'PAYDEKCOL',1,2493,'1.300000')
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod, CommissionCurrency,CommissionValue)
values ('Paydek Brasil', 'Paydek Brasil', 'alan.barry@paydek.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'PAYDEKBRA',1,2493,'0.900000')
...
values ('Paydek', 'Paydek', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'0.900000',2493)

	--COL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Paydek', 'Paydek', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'1.300000',2493)

	--BRA
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Paydek', 'Paydek', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'0.900000',2493)
----------------
...
values ('000004000001', '@mKS5;%+Y6fUh9$$', @idEntityUserArg, 1, 1)

--COL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000004000001', 'E-!;25R#$~,tj>-<', @idEntityUserCol, 49, 1)

--BRA
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000004000001', ']_}ghdmAW4(%hK3K', @idEntityUserBra, 31, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('k8[Q[kKA/av2!p*W','k8[Q[kKA/av2!p*W',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
