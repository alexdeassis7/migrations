...
values ('PMI Ripple Argentina', 1, 1)
...
insert into LP_Entity.EntityMerchant
(Description, idEntityBusinessNameType, Active)
values ('PMI Ripple Colombia', 1, 1)
...
values ('PMI Ripple Argentina', 'PMI Ripple Argentina', 'pmi-ripple@pmi-americas.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'PMIRIPARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('PMI Ripple Colombia', 'PMI Ripple Colombia', 'pmi-ripple@pmi-americas.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'PMIRIPCOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('PMI Ripple Brasil', 'PMI Ripple Brasil', 'pmi@pmi-americas.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'PMIRIPBRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('PMI Ripple Mexico', 'PMI Ripple Mexico', 'pmi@pmi-americas.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'PMIRIPMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('PMI Ripple Uruguay', 'PMI Ripple Uruguay', 'pmi@pmi-americas.com', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'PMIRIPURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('PMI Ripple Chile', 'PMI Ripple Chile', 'pmi@pmi-americas.com', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'PMIRIPCHL',1)
...
values ('PMI Ripple', 'PMI Ripple', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'1.300000',2493)

	--COL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('PMI Ripple', 'PMI Ripple', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'1.300000',2493)

	--BRA
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('PMI Ripple', 'PMI Ripple', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'10.000000',2493)

	--MEX
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('PMI Ripple', 'PMI Ripple', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'1.300000',2493)

	--URY
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('PMI Ripple', 'PMI Ripple', @idEntityUserUry, 1, 0, 1, '', '', 0, 1,'1.300000',2493)

	--CHL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('PMI Ripple', 'PMI Ripple', @idEntityUserChl, 1, 0, 1, '', '', 0, 1,'1.300000',2493)
----------------
...
values ('000002300002', 'jV3mCdcDMvcz4fCe', @idEntityUserArg, 1, 1)

--COL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002300002', 'jV3mCdcDMvcz4fCe', @idEntityUserCol, 49, 1)

--BRA
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002300002', 'jV3mCdcDMvcz4fCe', @idEntityUserBra, 31, 1)

--MEX
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002300002', 'jV3mCdcDMvcz4fCe', @idEntityUserMex, 150, 1)

--URY
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002300002', 'jV3mCdcDMvcz4fCe', @idEntityUserUry, 244, 1)

--CHL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002300002', 'jV3mCdcDMvcz4fCe', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EACB002302','M8weHF5m6gQ5WVch',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
