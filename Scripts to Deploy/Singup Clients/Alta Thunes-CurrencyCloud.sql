...
values ('Thunes - CurrencyCloud Mexico', 1, 1)
...
values ('Thunes - CurrencyCloud Mexico', 'Thunes - CurrencyCloud Mexico', 'currencycloud@thunes.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPTHCCMEX',1)
...
values ('CURRENCYCLOUD MEX', 'CURRENCYCLOUD', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'1.600000',2493)
...
values ('000002000005', 'CABJ5Rgtywf53bPV', @idEntityUserMex, 150, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EATHCC2005','F<B$7b3FuG',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
