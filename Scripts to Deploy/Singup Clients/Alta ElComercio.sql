...
values ('El Comercio Argentina', 1, 1)
...
insert into LP_Entity.EntityMerchant
(Description, idEntityBusinessNameType, Active)
values ('El Comercio Colombia', 1, 1)
...
insert into LP_Entity.EntityMerchant
(Description, idEntityBusinessNameType, Active)
values ('El Comercio Uruguay', 1, 1)
...
values ('El Comercio Argentina', 'El Comercio Argentina', 'elcomercio@localpayment.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'LPELCMARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('El Comercio Colombia', 'El Comercio Colombia', 'elcomercio@localpayment.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'LPELCMCOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('El Comercio Brasil', 'El Comercio Brasil', 'elcomercio@localpayment.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'LPELCMBRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('El Comercio Mexico', 'El Comercio Mexico', 'elcomercio@localpayment.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPELCMMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('El Comercio Uruguay', 'El Comercio Uruguay', 'elcomercio@localpayment.com', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'LPMGGIURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('El Comercio Chile', 'El Comercio Chile', 'elcomercio@localpayment.com', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'LPMGGICHL',1)
...
values ('EL COMERCIO ARG', 'EL COMERCIO', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'0.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('EL COMERCIO COL', 'EL COMERCIO', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'0.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('EL COMERCIO BRA', 'EL COMERCIO', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'0.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('EL COMERCIO MEX', 'EL COMERCIO', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'0.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('EL COMERCIO URU', 'EL COMERCIO', @idEntityUserUry, 1, 0, 1, '', '', 0, 1,'0.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('EL COMERCIO CHI', 'EL COMERCIO', @idEntityUserChl, 1, 0, 1, '', '', 0, 1,'0.000000',2493)
----------------
...
insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy,Active, Version)
values (2494, 244, 2, @idEntityUserUry, 3.00, 3.00, 1, 1)

insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy,Active, Version)
values (2493, 244, 2, @idEntityUserUry, 3.00, 3.00, 1, 1)
...
values ('000002200001', 'BzaeaV8HfMngmQNu', @idEntityUserArg, 1, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002200001', 'BzaeaV8HfMngmQNu', @idEntityUserCol, 49, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002200001', 'BzaeaV8HfMngmQNu', @idEntityUserBra, 31, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002200001', 'BzaeaV8HfMngmQNu', @idEntityUserMex, 150, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002200001', 'BzaeaV8HfMngmQNu', @idEntityUserUry, 244, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002200001', 'BzaeaV8HfMngmQNu', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EAELCM2201','G9K?D&&b88',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
