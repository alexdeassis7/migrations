...
values ('MassPay Argentina', 'MassPay Argentina', 'logan@masspay.io', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'LPMPAYARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('MassPay Colombia', 'MassPay Colombia', 'logan@masspay.io', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'LPMPAYCOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('MassPay Brasil', 'MassPay Brasil', 'logan@masspay.io', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'LPMPAYBRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('MassPay Mexico', 'MassPay Mexico', 'logan@masspay.io', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPMPAYMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('MassPay Uruguay', 'MassPay Uruguay', 'logan@masspay.io', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'LPMPAYURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('MassPay Chile', 'MassPay Chile', 'logan@masspay.io', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'LPMPAYCHL',1)
...
values ('MassPay', 'MassPay', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

	--COL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('MassPay', 'MassPay', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

	--BRA
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('MassPay', 'MassPay', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

	--MEX
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('MassPay', 'MassPay', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

	--URY
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('MassPay', 'MassPay', @idEntityUserUry, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--CHL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('MassPay', 'MassPay', @idEntityUserChl, 1, 0, 1, '', '', 0, 1,'1.000000',2493)
----------------
...
values (2350, 1, 2, @idEntityUserArg, 0.7, 0.7, 1, 1)

insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy,Active, Version)
values (2493, 1, 2, @idEntityUserArg, 0.7, 0.7, 1, 1)
...
values ('000002600001', 'pAqZjVN7Ch', @idEntityUserArg, 1, 1)

--COL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002600001', 'PFH9PnhLZp', @idEntityUserCol, 49, 1)

--BRA
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002600001', 'zt8JKVMbQS', @idEntityUserBra, 31, 1)

--MEX
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002600001', 'uA5vxuqSBL', @idEntityUserMex, 150, 1)

--URY
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002600001', '5zTGC5KDZ9', @idEntityUserUry, 244, 1)

--CHL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002600001', '3GpESwfP9M', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EACB002600','uXcpQ2g6x8',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
