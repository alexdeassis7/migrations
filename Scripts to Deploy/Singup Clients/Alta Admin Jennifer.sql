...
values ('Jennifer', 'Jennifer', 'jennifer@localpayment.com', '', '', 1, 1, null , 1, 1, 1, '', 'LPSJENN',1)
...
values ('000000000007', 'DZ${k3cDr4yr!qqa', @idEntityUser, 1, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EACB000002','HhKyjakS9rEDZ6uu',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
