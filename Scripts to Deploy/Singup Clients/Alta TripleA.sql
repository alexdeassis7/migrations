...
values ('TripleA Argentina', 'TripleA Argentina', 'triplea@localpayment.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'LPTRPAARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('TripleA Colombia', 'TripleA Colombia', 'triplea@localpayment.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'LPTRPACOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('TripleA Brasil', 'TripleA Brasil', 'triplea@localpayment.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'LPTRPABRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('TripleA Mexico', 'TripleA Mexico', 'triplea@localpayment.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPTRPAMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('TripleA Uruguay', 'TripleA Uruguay', 'triplea@localpayment.com', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'LPTRPAURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('TripleA Chile', 'TripleA Chile', 'triplea@localpayment.com', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'LPTRPACHL',1)
...
values ('TRIPLE-A ARG', 'TRIPLE-A', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('TRIPLE-A COL', 'TRIPLE-A', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'2.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('TRIPLE-A BRA', 'TRIPLE-A', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'2.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('TRIPLE-A MEX', 'TRIPLE-A', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'2.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('TRIPLE-A URU', 'TRIPLE-A', @idEntityUserUry, 1, 0, 1, '', '', 0, 1,'2.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('TRIPLE-A CHI', 'TRIPLE-A', @idEntityUserChl, 1, 0, 1, '', '', 0, 1,'2.500000',2493)
----------------
...
values ('000006100001', 'wGhBqdZr6kXvpb7a', @idEntityUserArg, 1, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000006100001', 'wGhBqdZr6kXvpb7a', @idEntityUserCol, 49, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000006100001', 'wGhBqdZr6kXvpb7a', @idEntityUserBra, 31, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000006100001', 'wGhBqdZr6kXvpb7a', @idEntityUserMex, 150, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000006100001', 'wGhBqdZr6kXvpb7a', @idEntityUserUry, 244, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000006100001', 'wGhBqdZr6kXvpb7a', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EATRPA6001','9wt$NP#wUx',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
