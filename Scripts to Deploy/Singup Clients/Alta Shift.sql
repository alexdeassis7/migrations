...
values ('Shift Argentina', 'Shift Argentina', 'z.musallam@shift-sg.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'LPSHIARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Shift Colombia', 'Shift Colombia', 'z.musallam@shift-sg.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'LPSHICOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Shift Brasil', 'Shift Brasil', 'z.musallam@shift-sg.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'LPSHIBRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Shift Mexico', 'Shift Mexico', 'z.musallam@shift-sg.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPSHIMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Shift Uruguay', 'Shift Uruguay', 'z.musallam@shift-sg.com', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'LPSHIURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Shift Chile', 'Shift Chile', 'z.musallam@shift-sg.com', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'LPSHICHL',1)
...
values ('Shift', 'Shift', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'0.500000',2493)

	--COL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Shift', 'Shift', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

	--BRA
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Shift', 'Shift', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'1.000000',2493)

	--MEX
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Shift', 'Shift', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'0.750000',2493)

	--URY
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Shift', 'Shift', @idEntityUserUry, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--CHL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Shift', 'Shift', @idEntityUserChl, 1, 0, 1, '', '', 0, 1,'1.500000',2493)
----------------
...
insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy,Active, Version)
values (2446, 150, 2, @idEntityUserMex, 0.80, 0.80, 1, 1)

insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy,Active, Version)
values (2493, 150, 2, @idEntityUserMex, 0.80, 0.80, 1, 1)
...
values ('000002800001', 'Dy4Kv%$K8A/yK3?H', @idEntityUserArg, 1, 1)

--COL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002800001', 'Dy4Kv%$K8A/yK3?H', @idEntityUserCol, 49, 1)

--BRA
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002800001', 'Dy4Kv%$K8A/yK3?H', @idEntityUserBra, 31, 1)

--MEX
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002800001', 'Dy4Kv%$K8A/yK3?H', @idEntityUserMex, 150, 1)

--URY
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002800001', 'Dy4Kv%$K8A/yK3?H', @idEntityUserUry, 244, 1)

--CHL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000002800001', 'Dy4Kv%$K8A/yK3?H', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EASF002800','%?t_Da92eF',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
