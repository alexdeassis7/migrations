...
values ('Efx Capital - Argentina', 1, 1)
...
insert into LP_Entity.EntityMerchant
(Description, idEntityBusinessNameType, Active)
values ('Efx Capital - Colombia', 1, 1)
...
insert into LP_Entity.EntityMerchant
(Description, idEntityBusinessNameType, Active)
values ('Efx Capital - Uruguay', 1, 1)
...
values ('Efx Capital - Argentina', 'Efx Capital - Argentina', 'mark@efx-capital.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'LPEFXARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Efx Capital - Colombia', 'Efx Capital - Colombia', 'mark@efx-capital.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'LPEFXCOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Efx Capital - Brasil', 'Efx Capital - Brasil', 'mark@efx-capital.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'LPEFXBRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Efx Capital - Mexico', 'Efx Capital - Mexico', 'mark@efx-capital.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPEFXMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Efx Capital - Uruguay', 'Efx Capital - Uruguay', 'mark@efx-capital.com', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'LPEFXURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('Efx Capital - Chile', 'Efx Capital - Chile', 'mark@efx-capital.com', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'LPEFXCHL',1)
...
values ('Efx Capital', 'Efx Capital', @idEntityUserArg, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--COL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Efx Capital', 'Efx Capital', @idEntityUserCol, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--BRA
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Efx Capital', 'Efx Capital', @idEntityUserBra, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--MEX
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Efx Capital', 'Efx Capital', @idEntityUserMex, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--URY
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Efx Capital', 'Efx Capital', @idEntityUserUry, 1, 0, 1, '', '', 0, 1,'1.500000',2493)

	--CHL
insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('Efx Capital', 'Efx Capital', @idEntityUserChl, 1, 0, 1, '', '', 0, 1,'1.500000',2493)
----------------
...
values ('000003100001', 'T6dgb478CtTbZSDz', @idEntityUserArg, 1, 1)

--COL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000003100001', 'mY49awdqQpwScRRJ', @idEntityUserCol, 49, 1)

--BRA
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000003100001', 'P7YGKFzN2qBfaz7g', @idEntityUserBra, 31, 1)

--MEX
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000003100001', 'mHMJN636zR3wPCjD', @idEntityUserMex, 150, 1)

--URY
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000003100001', 'sCPjwN2dE7vFVjuQ', @idEntityUserUry, 244, 1)

--CHL
insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000003100001', 'uYehrZyHafpF264D', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EACB003100','XkgVdW9Cmpc3BwMN',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
