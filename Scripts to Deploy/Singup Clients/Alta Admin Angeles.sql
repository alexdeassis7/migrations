...
values ('Angeles', 'Aletto', 'angeles.aletto@localpayment.com', '', '', 1, 1, null , 1, 1, 1, '', 'LPANALE',1)
...
INSERT INTO [LP_Security].[EntityAccount]
     ...
     VALUES
           ('000000000010'
           ,NEWID()
           ,'angeles.aletto@localpayment.com'
           ,1
           ,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
...
values ('000000000010', 'UhsJ8mwnnLqZyFRq', @idEntityUser, 1, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EACB000010','Vc4cFE1jL6a3hyzS',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
