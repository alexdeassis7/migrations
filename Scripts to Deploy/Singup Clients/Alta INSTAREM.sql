...
values ('INSTAREM Argentina', 'INSTAREM Argentina', 'instarem@localpayment.com', '', '', 2, 4, @idEntityMerchantArg , 4, 1, 1, '', 'LPNIUMARG',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('INSTAREM Colombia', 'INSTAREM Colombia', 'instarem@localpayment.com', '', '', 2, 4, @idEntityMerchantCol , 4, 1, 49, '', 'LPNIUMCOL',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('INSTAREM Brasil', 'INSTAREM Brasil', 'instarem@localpayment.com', '', '', 2, 4, @idEntityMerchantBra , 4, 1, 31, '', 'LPNIUMBRA',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('INSTAREM Mexico', 'INSTAREM Mexico', 'instarem@localpayment.com', '', '', 2, 4, @idEntityMerchantMex , 4, 1, 150, '', 'LPNIUMMEX',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('INSTAREM Uruguay', 'INSTAREM Uruguay', 'instarem@localpayment.com', '', '', 2, 4, @idEntityMerchantUry , 4, 1, 244, '', 'LPNIUMURY',1)
...
insert into LP_Entity.EntityUser
(LastName, FirstName, MailAccount, TelephoneNumber, MobileNumber, idEntityType, idEntityIdentificationType, idEntityMerchant, idEntityAdress, Active, idCountry, AccountNumberLP, MerchantAlias, fxPeriod)
values ('INSTAREM Chile', 'INSTAREM Chile', 'instarem@localpayment.com', '', '', 2, 4, @idEntityMerchantChl , 4, 1, 44, '', 'LPNIUMCHL',1)
...
values ('INSTAREM', 'INSTAREM', @idEntityUserArg, 0, 0, 1, '', '', 0, 1,'0.750000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('INSTAREM', 'INSTAREM', @idEntityUserCol, 0, 0, 1, '', '', 0, 1,'0.850000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('INSTAREM', 'INSTAREM', @idEntityUserBra, 0, 0, 1, '', '', 0, 1,'1.000000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('INSTAREM', 'INSTAREM', @idEntityUserMex, 0, 0, 1, '', '', 0, 1,'0.600000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('INSTAREM', 'INSTAREM', @idEntityUserUry, 0, 0, 1, '', '', 0, 1,'0.600000',2493)

insert into LP_Entity.EntitySubMerchant
(Description, SubMerchantIdentification, idEntityUser, isDefault, WithRetentions, Active, SubMerchantCode, SubMerchantAddress, WithRetentionsARBA, IsCorporate,CommissionValuePO, CommissionCurrencyPO)
values ('INSTAREM', 'INSTAREM', @idEntityUserChl, 0, 0, 1, '', '', 0, 1,'0.600000',2493)
----------------
...
insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy, Active, Version)
values (2363, 31, 2, @idEntityUserBra, 0.70, 0.70, 1, 1)

insert into [LP_Configuration].[CurrencyBase]
(idCurrencyType, idCountry, idUnit, idEntityUser, Base_Sell, Base_Buy, Active, Version)
values (2493, 31, 2, @idEntityUserBra, 0.70, 0.70, 1, 1)
...
INSERT INTO [LP_Security].[EntityAccount]
     ...
     VALUES
           ('000005000001'
		   ,'8332951A-0EAA-45B4-8834-C9F685B3EB0A'
           ,'instarem@localpayment.com'
           ,1
           ,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
...
values ('000005000001', 'IREM#R#001', @idEntityUserArg, 1, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000005000001', 'IREM##C01', @idEntityUserCol, 49, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000005000001', 'IREM##BR1', @idEntityUserBra, 31, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000005000001', 'IREM##MX1', @idEntityUserMex, 150, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000005000001', 'IREM##UY1', @idEntityUserUry, 244, 1)

insert into LP_Security.EntityApiCredential
(Identification, ApiKey, idEntityUser, idCountry, Active)
values ('000005000001', 'IREM##CHL1', @idEntityUserChl, 44, 1)

---- ENTITY PASSWORD

insert into LP_Security.EntityPassword values ('EAC0004000','$REM#SQ1_4',GETDATE(),1,1,GETUTCDATE()
           ,GETUTCDATE()
           ,GETDATE()
           ,GETDATE())
