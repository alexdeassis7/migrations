...
ALTER PROCEDURE [LP_Operation].[BRA_Payout_Generic_Entity_Operation_Create]
																				(
...
BEGIN
	...
	BEGIN TRY
			...
			SET @idCountry = [LP_Location].[fnGetIdCountyByCountryCode]('BRL')	
			...
			INSERT  INTO #LotTrans ([Value], [TransactionDate], [Recipient], [IdType], [Id], [CBU],
			 ...
			 [ConceptCode], [BankAccountType], [CurrencyType], /*[FirstName] , [LastName],*/ [Email] , [Address] ,
			  ...
			  [SubMerchant], [BankCode], [BankBranch], [LengthRecipientAccountNumber],[ZipCode],[SenderZipCode])
			SELECT
				[Value]
				, [TransactionDate]
				, [Recipient]
			...
			(
				...
				[BankBranch]					[LP_Common].[LP_F_C100] '$.BankBranch',
			...
			BEGIN	
				...
				BEGIN
					...
					EXEC [LP_KPI].[BRA_Payout_Generic_fx_Create] @idTransactionLot = @LoteNum, @country_code = @idCountry
													...
													SELECT TOP 1
														...
														, [Transactions]	= 
																				...
																				SELECT
																					...
																					, [TransactionRecipientDetail.BankBranch]						= [LT].[BankBranch]
																					...
																					, [TransactionRecipientDetail.CurrencyType]						= 'BRL'
