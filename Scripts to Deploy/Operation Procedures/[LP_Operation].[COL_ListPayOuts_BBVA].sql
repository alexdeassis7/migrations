DROP PROCEDURE IF EXISTS [LP_Operation].[COL_ListPayOuts_BBVA];
/****** Object:  StoredProcedure [LP_Operation].[COL_ListPayOuts_BBVA]    Script Date: 3/11/2020 5:52:40 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [LP_Operation].[COL_ListPayOuts_BBVA]
													(
	...
	BEGIN
		...
		SELECT [TL].[LotNumber]
				...
				WHERE
					...
					AND [BC].[Code] IN ('1013','1001','1002','1006','1007','1008','1009','1010','1012','1014','1019',
                                        '1023','1031','1032','1040','0041','1051','1052','1053','1058','1059','1060',
                                        '1061','1062','1063','1067','0076','0083','0084','0086','0087','0088','0089',
                                        '0090','1283','1289','1292','1121','0550','0683','1507','1151','1551')
