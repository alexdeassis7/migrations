...
ALTER PROCEDURE [LP_Operation].[ARG_Payout_BBVA_Bank_Operation_Download]
																			(
...
BEGIN
			...
			BEGIN TRY
					...
					SET @idProvider = ( SELECT [idProvider] FROM [LP_Configuration].[Provider] WHERE [Code] = 'BBBVA' AND [idCountry] = @idCountry AND [Active] = 1 )
			...
			/* HEADER BLOCK: INI */
					...
					DECLARE @HContratoProv AS VARCHAR(20) = '00170316192700000243'
