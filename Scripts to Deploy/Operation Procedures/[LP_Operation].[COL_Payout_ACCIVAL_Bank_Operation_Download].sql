...
GO
/****** Object:  StoredProcedure [LP_Operation].[COL_Payout_ACCIVAL_Bank_Operation_Download]    Script Date: 10/03/2021 19:06:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE OR ALTER PROCEDURE [LP_Operation].[COL_Payout_ACCIVAL_Bank_Operation_Download]
																					(
...
BEGIN
	...
	BEGIN TRY
			...
			SELECT
				...
				, [PaymentDescription]		    = LEFT([T2].[Ticket] + 'LOCALPAYMENT                                                                    ', 80)
