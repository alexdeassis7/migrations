...
/****** Object:  StoredProcedure [LP_Operation].[COL_Payout_Generic_Entity_Operation_List]    Script Date: 3/24/2020 7:26:18 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [LP_Operation].[BRA_Payout_Generic_Entity_Operation_List]
                                      (
                                        @customer       VARCHAR(12)
...
--DECLARE @JSON   [LP_Common].[LP_F_VMAX]
--SET @customer = '000001500001'
--SET @JSON = '{"payout_id":415, "transaction_id":0,"site_transaction_id":null,"date_from":"20191201","date_to":"20191220","ErrorRow":{"Errors":[],"HasError":false}}'
