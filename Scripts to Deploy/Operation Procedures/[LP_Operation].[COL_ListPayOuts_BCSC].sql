DROP PROCEDURE IF EXISTS [LP_Operation].[COL_ListPayOuts_BCSC];
/****** Object:  StoredProcedure [LP_Operation].[COL_ListPayOuts_BCSC]    Script Date: 3/11/2020 5:52:40 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [LP_Operation].[COL_ListPayOuts_BCSC]
													(
	...
	BEGIN
		...
		SELECT [TL].[LotNumber]
				...
				WHERE
					...
					AND [BC].[Code] IN ('1052','1040','1032','1001','1023','1062','1060','1002','1007','1061','1013','1009','1019','1292','1283','1051','1012','1058','1502','1551','1151','1507','1063','1014','1006','0550','1076','1090','1066')
