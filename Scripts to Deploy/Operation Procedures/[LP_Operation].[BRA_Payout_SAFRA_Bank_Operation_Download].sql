...
CREATE OR ALTER PROCEDURE [LP_Operation].[BRA_Payout_SAFRA_Bank_Operation_Download]
																			(
...
BEGIN
			...
			BEGIN TRY
					...
					SET @LPBankBranch = '00112'

					DECLARE @LPBankAccountNumber AS VARCHAR(12)
					SET @LPBankAccountNumber = '000000290813'

					DECLARE @LPBankAccountVerifier AS CHAR(1)
					SET @LPBankAccountVerifier = '7'
			...
			/* HEADER BLOCK: INI */
					...
					DECLARE @HNomBanco AS VARCHAR(30) = LEFT('BANCO SAFRA S/A' + SPACE(30), 30)
