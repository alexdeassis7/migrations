/****** Object:  StoredProcedure [LP_Operation].[COL_Payout_BANCOLOMBIA_Bank_Operation_Download]    Script Date: 3/11/2020 11:08:35 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [LP_Operation].[COL_Payout_BANCOLOMBIA_Bank_Operation_Download]
																					(
...
BEGIN
	...
	BEGIN TRY
			...
			SET @idProvider = ( SELECT [idProvider] FROM [LP_Configuration].[Provider] WHERE [Code] = 'BCOLOMBIA' AND [Active] = 1 )
