DROP PROCEDURE IF EXISTS [LP_Operation].[COL_ListPayOuts_ITAU];
/****** Object:  StoredProcedure [LP_Operation].[COL_ListPayOuts_ITAU]    Script Date: 3/11/2020 5:52:40 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [LP_Operation].[COL_ListPayOuts_ITAU]
													(
	...
	BEGIN
		...
		SELECT [TL].[LotNumber]
				...
				WHERE
					...
					AND [BC].[Code] IN ('1001','1002','1006','1007','1009','1012','1013','1014','1019','1023','1032','1040','1051','1052','1058','1060','1061','1062')
