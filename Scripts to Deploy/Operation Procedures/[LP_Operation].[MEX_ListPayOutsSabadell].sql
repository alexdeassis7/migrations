...
GO
/****** Object:  StoredProcedure [LP_Operation].[MEX_ListPayOutsSabadell]    Script Date: 11/02/2021 08:11:26 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE OR ALTER   PROCEDURE [LP_Operation].[MEX_ListPayOutsSabadell]
													(
