...
ALTER PROCEDURE [LP_Operation].[URY_Payout_Generic_Entity_Operation_Create]
																				(
...
BEGIN
	...
	BEGIN TRY
			...
			SET @idCountry = [LP_Location].[fnGetIdCountyByCountryCode]('UYU')	
			...
			BEGIN	
				...
				BEGIN
					...
					SELECT @idProvider = [idProvider] FROM [LP_Configuration].[Provider] WHERE [idCountry] = @idCountry AND [Code] = @ProviderCode
					...
					EXEC [LP_KPI].[URY_Payout_Generic_fx_Create] @idTransactionLot = @LoteNum, @country_code = @idCountry
													...
													SELECT TOP 1
														...
														, [Transactions]	= 
																				...
																				SELECT
																					...
																					, [TransactionRecipientDetail.CurrencyType]						= 'UYU'
