...
/****** Object:  StoredProcedure [LP_Operation].[MEX_ListPayOuts]    Script Date: 4/3/2022 12:55:45 ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [LP_Operation].[MEX_ListPayOuts]
													(
...
AS
	BEGIN
		...
		BEGIN
			...
			WHERE LEFT([TRD].[RecipientAccountNumber], 3) != '042'
		END
		ELSE
		BEGIN
			DELETE [TEMP]
