...
CREATE   PROCEDURE [LP_Operation].[CRI_Payout_Generic_Entity_Operation_List]
                                      (
                                        @customer       VARCHAR(12)
...
*/
  ...
  SET @idCountry = ( SELECT [idCountry] FROM  [LP_Location].[Country] WHERE [ISO3166_1_ALFA003] = 'CRI' ) 
