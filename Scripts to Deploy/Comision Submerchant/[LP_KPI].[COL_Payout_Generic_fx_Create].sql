...
GO
ALTER PROCEDURE [LP_KPI].[COL_Payout_Generic_fx_Create]
                                  (
        ...
        BEGIN TRANSACTION
          ...
          BEGIN
            WHILE(@idxTransaction <= @qtyTransactions)
              ...
              SET @fxProviderCommissionWithVAT  = ROUND(@ProviderCommission + @fxProviderVAT, 2)
              ...
              (
                ...
                , @TransactionDate
                , @Value
                , 0 --@fxClientTaxWithHoldings--ISNULL([LP_Retentions_ARG].[fnGetRetentionAmount](@Value, @idEntityUser, @RecipientCUIT ), 0)
                , 0 --@fxClientTaxWithHoldingsARBA--ISNULL([LP_Retentions_ARG].[fnGetRetentionAmount](@Value, @idEntityUser, @RecipientCUIT ), 0)
                , @Value 
                , @ClientCommission
                , @fxClientVAT        
